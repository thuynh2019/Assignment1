...
let totalTimeOfActivities = brushTeeth + uploadPhotos + chooseClothes + shower + goJogging + finishHomework + fixLunch
...
let likeToDo = finishHomework + fixLunch + goJogging

let notHaveToDo = uploadPhotos + chooseClothes
/*:
