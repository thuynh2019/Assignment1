...
let totalTicketValue = numberOfTickets * priceTicket

let totalExpenses = feeCount + posterCost

let totalIncomeOfShow = (numberOfTickets * priceTicket) - (feeCount + posterCost)
