...
*/
let storageData = 8000

let gigabyteData = 1000

let currentData = 3000

let oneVideoMinute = 150

let storageDataLeft = storageData - currentData

let minutesOfVideo = (storageData - currentData) / oneVideoMinute
