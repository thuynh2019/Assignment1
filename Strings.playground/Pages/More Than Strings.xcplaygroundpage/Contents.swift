...
let adjective = "black"
let noun = "PC"
let secondNoun = "Technology"
let place = "Center"
let emotion = "excited"
let negativeEmotion = "devastasted"

let stringStory = "Today was a big day for \(name). They had finally saved up \(number) dollars and were going to by a \(adjective + " " + noun). They went to the \(secondNoun + " " + place) feeling very \(emotion). But then they felt \(negativeEmotion). They were all out of \(noun)'s!"
//:
//:
